...
IL_0016:
	{
		...
		Dictionary_2_t0B15A60B00EC883D4249611C6C641C7BED5A71CE* L_17 = __this->___spawnedPrefabs_5;
...
// System.Void ImageTracking::OnEnabled()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ImageTracking_OnEnabled_m10DFC0C8AAC613E221692782F175BB3395E2199E (ImageTracking_t1AC7FA07584DA88ECCD67B79C21A12B615A4DAAC* __this, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ImageTracking_UpdateImage_m34C65707C9429E72DDE79B5A2800710CF5750904 (ImageTracking_t1AC7FA07584DA88ECCD67B79C21A12B615A4DAAC* __this, ARTrackedImage_tC1D6394277D354FB2B952C6D5CAB62140AA455C2* ___trackedImage0, const RuntimeMethod* method) 
{
	...
	Enumerator_t44F706C297E7C39CC8E9C45CF3D7CF388A1A9A05 V_2;
	...
	GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* V_3 = NULL;
	{
		...
		Dictionary_2_t0B15A60B00EC883D4249611C6C641C7BED5A71CE* L_5 = __this->___spawnedPrefabs_5;
		String_t* L_6 = V_0;
		NullCheck(L_5);
		...
		Dictionary_2_t0B15A60B00EC883D4249611C6C641C7BED5A71CE* L_11 = __this->___spawnedPrefabs_5;
		NullCheck(L_11);
...
FINALLY_006c:
			{// begin finally (depth: 1)
				Enumerator_Dispose_m696B5831B239FA49B7C6E9E829D5C2BA96B0E1AF((&V_2), Enumerator_Dispose_m696B5831B239FA49B7C6E9E829D5C2BA96B0E1AF_RuntimeMethod_var);
				return;
			}// end finally (depth: 1)
		});
		try
...
IL_0044_1:
			{
				...
				L_14 = Enumerator_get_Current_mD7296BB33D16F06FD06E6077D093543842DCAE4F_inline((&V_2), Enumerator_get_Current_mD7296BB33D16F06FD06E6077D093543842DCAE4F_RuntimeMethod_var);
				V_3 = L_14;
				...
				String_t* L_17 = V_0;
				bool L_18;
				L_18 = String_op_Inequality_m0FBE5AC4931D312E5B347BAA603755676E6DA2FE(L_16, L_17, NULL);
				if (!L_18)
				{
					goto IL_0061_1;
				}
...
IL_0061_1:
			{
				// foreach(GameObject gameObject in spawnedPrefabs.Values) {
				bool L_20;
				L_20 = Enumerator_MoveNext_m82EA4A043BD1FC4DB303D820966EBFBD9916A134((&V_2), Enumerator_MoveNext_m82EA4A043BD1FC4DB303D820966EBFBD9916A134_RuntimeMethod_var);
				if (L_20)
				{
					goto IL_0044_1;
				}
